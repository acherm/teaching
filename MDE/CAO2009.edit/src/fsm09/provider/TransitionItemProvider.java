...
/**
 * This is the item provider adapter for a {@link fsm09.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Fsm09Package.Literals.TRANSITION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEtiquettePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_etiquette_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_etiquette_feature", "_UI_Transition_type"),
				 Fsm09Package.Literals.TRANSITION__ETIQUETTE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Transition)object).getEtiquette();
